...
def main():
    ...
    # filein = f'IBMF_T0_RRG_PD_Lotka_Volterra_transitions_av0_0.08_tol_1e-4_maxiter_10000_eps_0.000_N_1024_c_3.txt'
    ...
    # dpar_fixed = 0.003
    # shift_below_end = 0.2
    # shift_above_end = shift_above
    # dpar_trans = 0.004
    

    # GMF
    # path_in = "/media/david/Data/UH/Grupo_de_investigacion/Ecology/Results/GMF/"
    # filein = f'GMF_T0_RRG_PD_Lotka_Volterra_transitions_av0_0.08_tol_1e-4_maxiter_10000_eps_0.000_N_1024_c_3.txt'
