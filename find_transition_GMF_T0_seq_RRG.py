...
def find_all_trans(path, eps, N, c, avn0, tol, max_iter, ndigits, nsamples, damping, nseq):
...
def main():
    ...
    find_all_trans(path, eps, N, c, avn0, tol, max_iter, ndigits, nsamples, damping, nseq)
