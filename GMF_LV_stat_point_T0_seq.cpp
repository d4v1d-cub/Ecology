...
void print_results(double av, int iter, Tnode *nodes, Tedge *edges, long N, long M, long seed, 
                   int max_iter, bool divergence, bool same_fixed_point, double normfactor = 1e-14){
...
int main(int argc, char *argv[]) {
    ...
    print_results(av, iter, nodes, edges, N, M, seed, max_iter, divergence, same_fixed_point);
